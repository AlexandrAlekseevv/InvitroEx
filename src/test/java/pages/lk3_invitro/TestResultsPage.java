...
public class TestResultsPage {
    ...
    @Getter private final SelenideElement orderNumberInputField = $x("//input[@name='orderNumber']").as("Код ИНЗ");
    @Getter private final SelenideElement birthDateInputField = $x("//input[@name='birthday']").as("Дата рождения");;
    @Getter private final SelenideElement lastNamInputField = $x("//input[@name='lastName']").as("Фамилия");;
